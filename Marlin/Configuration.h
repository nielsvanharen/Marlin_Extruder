...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
#define  DEFAULT_Kp 33.26
#define  DEFAULT_Ki 1.16
#define  DEFAULT_Kd 237.85
...
//#define DEFAULT_PSTEP_PER_MM 143.0  //default setting for the puller motor step calibration  1:5 gear
/**
 * Default Axis Steps Per Unit (steps/mm)
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.7402, 78.7402, 200.0*8/3, DEFAULT_PSTEP_PER_MM}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION       {9000,9000,100,900}
